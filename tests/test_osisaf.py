...
import vector_rotate as vr

from .plot import *

def test_osi_sea_ice(plot):
...
# rotate vector components
    ux, uy = vr.rotation_unit_vectors(x_from, y_from, crs_from, crs_to)
    rot_x, rot_y = vr.apply_vector_rotation(vec_x, vec_y, ux, uy)
